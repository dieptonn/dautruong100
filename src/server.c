                        ...
                        else
                        {
                                    ...
                                    if (rcvRequest->code == CHECK)
                                    {
                                        ...
                                        else //lucky lose->end game
                                        {
                                            ...
                                            char buffer[20];
                                                ...
                                                if(buffer == LUCKY_DEATH){

                                                for(int i ; i < 3 ; i++){
                                                    if(sockfd != client[i]){
                                                          sendResponse(client[i],"LUCKY_DEATH",sizeof(LUCKY_DEATH),0);
                                                          printf("da gui cho 2 thang con lai la thang lucky chet \n");
                            ...
                            case PLAYING:
                                ...
                                else
                                {
                                    ...
                                    // thong bao cho sever la thang lukey chet roi bay h chon lai thang lucky moi de
                                    else if(rcvRequest->code == LUCKY_DEATH){ 
