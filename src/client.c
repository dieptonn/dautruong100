                ...
                case PLAYING:
                    if (lucky == TRUE)
                    {
                        if (existQuestion == TRUE)
                        {
                            ...
                            // thong bao cho server minh la thang may man nhung minh cha loi sai cmnr chon thang khac di
                            if( (response -> code) == LOGOUT_SUCCESS){
                                char buffer[20];
                                strcpy(buffer,"LUCKY_DEATH");
                                int len = sizeof(buffer);
                                sendRequest(client_sock,buffer,len, 0);
                                printf("minh la thang lucky nhung minh chet\n");
                            }
                    ...
                    else
                    {
                        if (existQuestion == TRUE)
                        {
                            ...
                            if(status == LUCKY_DEATH){
                                printf("lucky death roi bay h phai chon lai nguoi lucky\n");

                            }
                            if(status == LUCK_TRUE){
                                // quay lai gan cho thang duoc nhan luck_true la thanh luckey
                            }
                            readMessageResponse(response);
                        }
                        else
